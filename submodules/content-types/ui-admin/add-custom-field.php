                ...
                <tr>
                    ...
                    <td>
                        <select name="field_type">
                            <option value="text" <?php if ( isset( $_POST['field_type'] ) && $_POST['field_type'] == 'text' ) echo( 'selected="selected"' ); ?>>Text Box</option>
                            <option value="textarea" <?php if ( isset( $_POST['field_type'] ) && $_POST['field_type'] == 'textarea' ) echo( 'selected="selected"' ); ?>>Multi-line Text Box</option>
                            <option value="radio" <?php if ( isset( $_POST['field_type'] ) && $_POST['field_type'] == 'radio' ) echo( 'selected="selected"' ); ?>>Radio Buttons</option>
                            <option value="checkbox" <?php if ( isset( $_POST['field_type'] ) && $_POST['field_type'] == 'checkbox' ) echo( 'selected="selected"' ); ?>>Checkboxes</option>
                            <option value="selectbox" <?php if ( isset( $_POST['field_type'] ) && $_POST['field_type'] == 'selectbox' ) echo( 'selected="selected"' ); ?>>Drop Down Select Box</option>
                            <option value="multiselectbox" <?php if ( isset( $_POST['field_type'] ) && $_POST['field_type'] == 'multiselectbox' ) echo( 'selected="selected"' ); ?>>Multi Select Box</option>
                        </select>
