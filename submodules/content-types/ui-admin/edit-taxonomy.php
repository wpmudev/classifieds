        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show-ui">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_ui" value="1" <?php if ( isset( $args['args']['show_ui'] ) && $args['args']['show_ui'] ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="show_ui" value="0" <?php if ( !isset( $args['args']['show_ui'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show_tagcloud">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_tagcloud" value="1" <?php if ( isset( $args['args']['show_tagcloud'] ) && $args['args']['show_tagcloud'] ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="show_tagcloud" value="0" <?php if ( !isset( $args['args']['show_tagcloud'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show-in-nav-menus">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_in_nav_menus" value="1" <?php if ( isset( $args['args']['show_in_nav_menus'] ) && $args['args']['show_in_nav_menus'] ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="show_in_nav_menus" value="0" <?php if ( !isset( $args['args']['show_in_nav_menus'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="hierarchical" value="1" <?php if ( isset( $args['args']['hierarchical'] ) && $args['args']['hierarchical'] ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="hierarchical" value="0" <?php if ( !isset( $args['args']['hierarchical'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="rewrite" value="1" <?php if ( isset( $args['args']['rewrite'] ) && $args['args']['rewrite'] == '1' ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="rewrite" value="0" <?php if ( isset( $args['args']['rewrite'] ) && $args['args']['rewrite'] == '0' ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                        <br />
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="query_var" value="1" <?php if ( isset( $args['args']['query_var'] ) && $args['args']['query_var'] ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="query_var" value="0" <?php if ( !isset( $args['args']['query_var'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
