            ...
            <table class="form-table publica">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br /><br />
                        <input type="radio" name="public" value="advanced" <?php if ( isset( $post_type['public'] ) && $post_type['public'] === NULL ) echo ( 'checked="checked"' ); ?>>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show-ui">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_ui" value="1" <?php if ( isset( $post_type['show_ui'] ) ) echo ( 'checked="checked"' ); ?>>
                        ...
                        <br />
                        <input type="radio" name="show_ui" value="0" <?php if ( !isset( $post_type['show_ui'] ) ) echo ( 'checked="checked"' ); ?>>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show-in-nav-menus">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_in_nav_menus" value="1" <?php if ( isset( $post_type['show_in_nav_menus'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="show_in_nav_menus" value="0" <?php if ( !isset( $post_type['show_in_nav_menus'] ) ) echo ( 'checked="checked"' ); ?>>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table public-queryable">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="publicly_queryable" value="1" <?php if ( isset( $post_type['publicly_queryable'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="publicly_queryable" value="0" <?php if ( !isset( $post_type['publicly_queryable'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table exclude-from-search">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="exclude_from_search" value="1" <?php if ( isset( $post_type['exclude_from_search'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="exclude_from_search" value="0" <?php if ( !isset( $post_type['exclude_from_search'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="hierarchical" value="1" <?php if ( isset( $post_type['hierarchical'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="hierarchical" value="0" <?php if ( !isset( $post_type['hierarchical'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="query_var" value="1" <?php if ( isset( $post_type['query_var'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="query_var" value="0" <?php if ( !isset( $post_type['query_var'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="can_export" value="1" <?php if ( isset( $post_type['can_export'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="can_export" value="0" <?php if ( !isset( $post_type['can_export'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                    </td>
                </tr>
            </table>
