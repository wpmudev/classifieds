...
<?php $options = $this->get_options('credits'); ?>
    ...
    <form action="" method="post">
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="checkbox" id="enable_credits" name="enable_credits" value="1" <?php if ( $options['enable_credits'] ) echo 'checked="checked"';  ?> />
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="cost_credit" name="cost_credit" value="<?php echo $options['cost_credit']; ?>" class="small-text" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="credits_per_week" name="credits_per_week" value="<?php echo $options['credits_per_week']; ?>" class="small-text" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="signup_credits" name="signup_credits" value="<?php echo $options['signup_credits']; ?>" class="small-text" />
            ...
            <tr>
                ...
                <td>
                    <textarea id="description" name="description" rows="1" cols="55"><?php echo $options['description']; ?></textarea>
                    <br />
