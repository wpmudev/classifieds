...
<h2>
    <?php if ( ( isset( $_GET['tab'] ) && ( $_GET['tab'] == 'general' || $_GET['tab'] == 'payments' ) ) || ( $_GET['page'] == 'classifieds_settings' && empty( $_GET['tab'] ) ) ): ?>
        <a class="nav-tab <?php if ( ( isset( $_GET['tab'] ) && $_GET['tab'] == 'general' ) || empty( $_GET['tab'] ) )  echo 'nav-tab-active'; ?>" href="admin.php?page=classifieds_settings&tab=general&sub=credits"><?php _e( 'General', $this->text_domain ); ?></a>
        <a class="nav-tab <?php if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'payments' ) echo 'nav-tab-active'; ?>" href="admin.php?page=classifieds_settings&tab=payments&sub=paypal"><?php _e( 'Payments', $this->text_domain ); ?></a>
    <?php elseif ( ( isset( $_GET['tab'] ) && ( $_GET['tab'] == 'my_credits' || $_GET['tab'] == 'send_credits' ) ) || ( $_GET['page'] == 'classifieds_credits' && empty( $_GET['tab'] ) ) ): ?>
        <a class="nav-tab <?php if ( ( isset( $_GET['tab'] ) && $_GET['tab'] == 'my_credits' ) || empty( $_GET['tab'] ) )  echo 'nav-tab-active'; ?>" href="admin.php?page=classifieds_credits&tab=my_credits"><?php _e( 'My Credits', $this->text_domain ); ?></a>
