			...
			<div class="inside">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" id="enable_annual" name="enable_annual" value="1" <?php checked( ! empty( $options['enable_annual'] ) );  ?> />
								<?php _e( 'Enable annual membership for publishing ads.', $this->text_domain ); ?>
							</label>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" id="annual_cost" class="small-text" name="annual_cost" value="<?php echo ( empty( $options['annual_cost'] ) ) ? '0' : $options['annual_cost']; ?>" />
							<span class="description"><?php _e( 'Cost of "Annual" service.', $this->text_domain ); ?></span>
							<br /><br />
							<input type="text" name="annual_txt" value="<?php echo ( empty( $options['annual_txt'] ) ) ? '' : $options['annual_txt']; ?>" />
			...
			<div class="inside">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" id="enable_once" name="enable_once" value="1" <?php checked( ! empty( $options['enable_once'] ) );  ?> />
