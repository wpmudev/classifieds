...
$cf = &$__classifieds_core; //shorthand reference
		...
		<div class="cf-padder">
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-content">
					...
					<?php
					if ( $cf->is_full_access() && $step != 'success' && $step != 'api_call_error' ) {
					...
					<?php endif; ?>
					<!--End PreLogin -->
					<?php elseif ( $step == 'terms' || $_GET['cf_step'] == 'terms' ): ?>
					<!-- Begin Terms -->
					<?php $cf_options = $cf->get_options(); ?>

					<form action="" method="post"  class="cf-checkout">

						<strong><?php _e( 'Cost of Service', 'classifieds' ); ?></strong>
						<table <?php do_action( 'billing_invalid' ); ?>>
							<?php if($cf->use_credits && ! $cf->is_full_access() ): ?>
							<tr>
								<td>
								<label for="billing"><?php _e( 'Buy Credits', 'classifieds' ) ?></label></td>
									<td>
										...
										<select name="credits_cost">
											...
											<option value="<?php echo $amount; ?>" <?php if ( isset( $_POST['credits_cost'] ) && $_POST['credits_cost'] == $amount ) echo 'selected="selected"'; ?> ><?php echo $credits; ?> Credits for <?php echo $amount . ' ' . $cf_options['payment_types']['currency']; ?></option>
												<?php endfor; ?>
											</select>
										</td>
									</tr>
									<?php endif; ?>
									<?php if ( $cf->use_annual ): ?>
									<tr>
										<td><label for="billing"><?php echo $cf_options['payments']['annual_txt']; ?></label></td>
										<td>
											<input type="radio" name="billing" value="annual" <?php if ( isset( $_POST['billing'] ) && $_POST['billing'] == 'annual' ) echo 'checked="checked"'; ?> />  <?php echo $cf_options['payments']['annual_cost']; ?> <?php echo $cf_options['payment_types']['currency']; ?>
									...
									<tr>
										...
										<td>
											<input type="radio" name="billing" value="one_time" <?php if ( isset( $_POST['billing'] ) && $_POST['billing'] == 'one_time' ) echo 'checked="checked"'; ?> /> <?php echo $cf_options['payments']['one_time_cost']; ?> <?php echo $cf_options['payment_types']['currency']; ?>
							...
							<?php if( empty($cf_options['payment_types']['free'] )): ?>

							<form action="" method="post"  class="cf-checkout">
								<strong><?php _e('Choose Payment Method', 'classifieds' ); ?></strong>
								<table>
									<?php if(! empty($cf_options['payment_types']['paypal'] )): ?>
									<tr>
									...
									<?php endif; ?>
									<?php if(! empty($cf_options['payment_types']['authorizenet'] )): ?>
									<tr>
							...
							<form action="" method="post" class="cf-checkout" id="cfcheckout">
								...
								<table>
									...
									<tr>
										...
										<td>
											<strong><?php echo $_POST['cost']; ?> <?php echo $cf_options['payment_types']['currency']; ?></strong>
